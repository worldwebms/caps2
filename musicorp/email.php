...
* Last Modified: 4/3/2004 By Aviv Efrat
...
if (isset($add_vuser)) {
	...
	$testresult = testAccount($v_username, $domain);
	if ($testresult == "yes") {
...
if ($event == "update_global") {
	...
	if ($ok == 0) {
		...
		//verify the file and send to david
...
if ($event == "export_list") {
	...
	echo "<script language='JavaScript'>window.open('../poplauncher.php','','width=600,height=400,resizable=yes,menubar=yes,scrollbars=yes')</script>";//end dopdf event
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td valign="top" class="text"> 
      <p><img src="../images/spacer.gif" width="233" height="14"></p></td>
