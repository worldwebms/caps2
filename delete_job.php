...
*
* delete_job template by WorldWeb Management Services ABN: 99 189 634 462
* Created on: 8/8/2003
* Client: WorldWeb, Domain: database intranet
* This template consists of 2 section: HTML form for deleting a job and delete query
...
if (isset($deleteme)) {
	$deletejob = strtolower($deletejob);
	if ($deletejob == "delete") {
		//delete the entry from the attachment table
		$query = "DELETE FROM jobs WHERE job_id='$job_id' AND client_id='$client_id'";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td>&nbsp;</td>
    <td valign="middle" class="text"><img src="images/spacer.gif" width="39" height="10"><br> 
	Delete This Job:
		...
		Please type "delete" in text box if you wish to delete this job<br>
		<input name="deletejob" type="text" size="8" class="black">
		<input class="smallbluebutton" type="submit" name="deleteme" value="Commit">
		</form>
      <p></p>
