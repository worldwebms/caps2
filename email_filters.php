...
global $myattachment_size;
	switch ($max_attachment_size) {
		case "512":
			$myattachment_size = "<option selected value=\"512\">512 KB</option>";
			break;
		case "1024":
			$myattachment_size = "<option selected value=\"1024\">1 MB</option>";
			break;
		case "1536":
			$myattachment_size = "<option selected value=\"1536\">1.5 MB</option>";
			break;
		case "2048":
			$myattachment_size = "<option selected value=\"2048\">2 MB</option>";
			break;
		case "2560":
			$myattachment_size = "<option selected value=\"2560\">2.5 MB</option>";
			break;
		case "3072":
			$myattachment_size = "<option selected value=\"3072\">3 MB</option>";
			break;
		case "4096":
			$myattachment_size = "<option selected value=\"4096\">4 MB</option>";
			break;
		case "5120":
...
//list all client domains in a drop down
$mydomains = "";
    ...
    <td colspan="2" valign="top" class="text"><u>Email Settings</u><br>
	  ...
	  <table>
        ...
        <tr height="30" valign="top">
          ...
          <td colspan="4" class="text"><input name="keep_mail" type="radio" value="yes" <?php echo $mykeep_mail1; ?>> 
            yes
              <input name="keep_mail" type="radio" value="no" <?php echo $mykeep_mail2; ?>> 
  no
</td>
        </tr>
        <tr height="30" valign="top">
	  ...
	  <table width="400" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <select name="attachment_size" size="1" class="black">
		  	<?php echo $max_attachment_size; ?>
			    <option value="3072">3000kb</option>
